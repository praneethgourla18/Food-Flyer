...
const ResCard =(props)=>{
 ...
 return(
    <div className="w-[240px] rounded-[10px] p-[10px] m-[18px] bg-[#FFF] shadow-lg border border-gray-200 transition-transform duration-200 ease-in-out z-10 hover:scale-[0.98]">  
